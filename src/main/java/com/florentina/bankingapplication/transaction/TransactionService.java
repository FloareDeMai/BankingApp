...
public interface TransactionService {
    ...
    Account deposit(String numberAccount, BigDecimal amount, TransactionType transactionType) throws AccountNotFoundException, AmountNegativeException, MinimumAmountException;

    Account withdrawal(String numberAccount, BigDecimal amount, TransactionType transactionType) throws AccountNotFoundException, AmountNegativeException, MinimumAmountException;
